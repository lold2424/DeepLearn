# -*- coding: utf-8 -*-
"""
v1 최종본 재현 학습 - 51장(Image_01.yolov11.zip) 데이터로 재학습해서
...
ZIP_PATH = '/content/drive/MyDrive/Image/Image_01.yolov11.zip'  # v1(51장) zip 경로 - 실제 위치로 확인 필요
EXTRACT_DIR = '/content/yolo11_v1_final'
...
# ============================================================
# 4. 학습 (v1 원본 설정 그대로 재현)
# ============================================================
ROUND_NAME = 'mini_seg_v1_final'
...
best_pt_dst = os.path.join(BACKUP_DIR, 'mini_seg_v1_final_best.pt')
